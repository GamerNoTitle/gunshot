...
- (NSArray *)specifiers{
 ...
 PSSpecifier *open=[PSSpecifier preferenceSpecifierNamed:@"Open GoToHP settings" target:self set:NULL get:NULL detail:Nil cell:PSButtonCell edit:Nil];open.buttonAction=@selector(openPanel);_specifiers=@[group,open];}return _specifiers;
}
