...
The current transport uses direct Mach lookup, a scoped libSandy profile and authenticated XPC discovery. The investigation below records earlier implementations and device reports.
