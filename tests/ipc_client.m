...
static void Exchange(NSUInteger route,BOOL malformed){
 Route=route;Lookups=0;ProfileCode=0;ProfileCalls=0;Discoveries=0;ProfileApplied=NO;Server=Endpoint();Broker=Endpoint();
 ...
 assert(Discoveries==(route==7?1:0));
...
int main(void){@autoreleasepool{
 ...
 Exchange(7,NO);Exchange(7,YES); // Profile success + denied raw lookup, XPC discovery then real RPC.
