...
xcrun --sdk iphonesimulator clang -fobjc-arc -isysroot "$sdk" \
 ...
 UI/GSPanel.m UI/GSBatchImport.m UI/GSAlbumPicker.m UI/GSAccountConnection.m UI/GSUploadMonitor.m UI/GSBackupLifecycle.m tests/settings_ui.m .build/runtime-fixture/EmbeddedService.o \
