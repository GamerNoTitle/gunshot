...
TWEAK_NAME = Gunshot
Gunshot_FILES = Tweak.xm Shared/IPCClient.m UI/GSPanel.m UI/GSAccountMenu.m UI/GSNativeAccount.m UI/GSExporter.m UI/GSNativeRouting.m UI/GSUploadDiagnostics.m
